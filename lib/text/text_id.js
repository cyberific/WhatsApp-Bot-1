...
*📖 Preloaded Stickers 📖*
*${prefix}halo*, *${prefix}asep*, *${prefix}tabah*, *${prefix}lutelat*, *${prefix}bayu*, *${prefix}payoy*, *${prefix}teja*, *${prefix}indihome*, *${prefix}palpale*, *${prefix}yamete*, *${prefix}papepap*, *${prefix}prank*
`;
